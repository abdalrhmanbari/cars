...
export default function DetailsId({ car }: { car: any }) {
  return (
    <div className="   w-3/4 bg-white  flex flex-col md:flex-row items-center gap-8   sm:justify-between shadow-lg m-auto p-[1.9rem]  ">
      ...
      <div className="flex flex-col gap-[0.2rem] ">
        <h1 className="  text-xl sm:text-4xl font-bold mb-[0.7rem] ">
          {car?.make}
        </h1>
